...
|----------------------------------------------------------------------------------------------------------|---------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|
| ```/calculator/calculate-estimated-pay ```                                                               | POST                | The end point calculates estimated pay for the full year [More...](docs/calculator/calculate-estimated-pay.md)                                                                   | Deprecated |
...
| ```/tai/:nino/employments/year/:year/income/:incomeType/status/:status ```                               | GET                 | The end point retrieves employments matching income type and status for a given year [More...](docs/employments/employments-by-status-and-type.md)                                | Live |
...
| ```/tai/:nino/tax-account/paye-data/exists ```                                                           | GET                 | The end point checks if paye-data is present for a given nino                                                                                                                     | Live |
...
| ```/tai/:nino/tax-account/tax-code-history/:year ```                                                     | GET                 | The end point returns tax code history for a given nino and tax year [More...](docs/taxaccount/tax-code-history.md)                                                             | Live |
| ```/tai/:nino/iabds/years/:year ```                                                                      | GET                 | The end point retrieves all IABDs for a given nino and year [More...](docs/iabds/iabds.md)                                                                                      | Live |
| ```/file-upload/callback ```                                                                             | POST                | The end point handles file upload callback events                                                                                                                                | Live |
| ```/session-cache ```                                                                                    | DELETE              | The end point will invalidate the cache.                                                                                                                                         | Live |
