...
case class EmploymentsWithAccounts(employments: Seq[Employment]) {

  lazy val amendEmployment: (Employment, Seq[Employment]) => Employment = (employment, currentCacheEmployments) =>
  ...
  lazy val amendEmploymentForTaxYear: (Employment, Seq[Employment]) => Employment = (employment, currentCacheEmployments) =>
  ...
  //TODO change name of current cached employments
  def mergeEmployments( currentCacheEmployments: Seq[Employment], amendEmployment: (Employment, Seq[Employment]) => Employment): Seq[Employment] = {
