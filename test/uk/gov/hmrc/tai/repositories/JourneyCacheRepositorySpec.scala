  ...
  "JourneyCacheRepository" must {
    ...
    "persist a named journey cache, and return the updated cache" when {
      ...
      "no existing cache is present for the specified journey" in {
        ...
        Await.result(sut.cached("testJourney", testCache), 5 seconds) mustBe testCache
      ...
      "an existing cache is present for the named journey" in {
        ...
        val sut = createSUT(mockConnector)
        Await.result(sut.cached("testJourney", testCache), 5 seconds) mustBe
      ...
      "an existing cache is present for the named journey, and the supplied cache replaces one of the existing values" in {
        ...
        val sut = createSUT(mockConnector)
        Await.result(sut.cached("testJourney", newCache), 5 seconds) mustBe
    ...
    "persist an individual value, and return the updated cache" when {
      ...
      "no existing cache is present for the specified journey" in {
        ...
        val sut = createSUT(mockConnector)
        Await.result(sut.cached("testJourney", "key3", "value3"), 5 seconds) mustBe expectedMap
      ...
      "an existing cache is present for the named journey" in {
        ...
        val sut = createSUT(mockConnector)
        Await.result(sut.cached("testJourney", "key5", "value5"), 5 seconds) mustBe expectedMap
      ...
      "an existing cache is present for the named journey, and the supplied value replaces one of the existing values" in {
        ...
        val sut = createSUT(mockConnector)
        Await.result(sut.cached("testJourney", "key4", "updated"), 5 seconds) mustBe expectedMap
    ...
    "retrive an existing cache, by journey name" in {
      ...
      val sut = createSUT(mockConnector)
      Await.result(sut.currentCache("exists"), 5 seconds) mustBe Some(existingCache)
      Await.result(sut.currentCache("doesntexist"), 5 seconds) mustBe None
    }
    ...
    "retrive an individual cached value, by journey name and key" in {
      ...
      val sut = createSUT(mockConnector)
      Await.result(sut.currentCache("exists", "key3"), 5 seconds) mustBe Some("value3")
      Await.result(sut.currentCache("exists", "key5"), 5 seconds) mustBe None
      Await.result(sut.currentCache("doesntexist", "nochance"), 5 seconds) mustBe None
    }
    ...
    "delete a named journey cache" in {
      ...
      val sut = createSUT(mockConnector)
      Await.result(sut.flush("testJourney"), 5 seconds)
