...
import uk.gov.hmrc.tai.metrics.metrics.{HasActionMetrics, HasMetrics}
...
class HasMetricsSpec
  ...
  class TestHasActionMetrics extends BaseController with HasActionMetrics with MockHasMetrics {
