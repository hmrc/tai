  ...
  "getPaymentsForYear" must {
    "return a Right Seq[AnnualAccount] object" when {
      "no value is cached" in {
        ...
        when(
          mockSessionCacheRepository
            .getFromSession[Either[UpstreamErrorResponseWrapper, Seq[AnnualAccount]]](any())(any(), any())
        ).thenReturn(Future.successful(None))

        when(
          mockSessionCacheRepository.putSession[Either[UpstreamErrorResponseWrapper, Seq[AnnualAccount]]](
            any(),
            any()
          )(any(), any(), any())
        )
        ...
        verify(mockSessionCacheRepository, times(1))
          .getFromSession[Either[UpstreamErrorResponseWrapper, Seq[AnnualAccount]]](any())(any(), any())
        verify(mockSessionCacheRepository, times(1))
          .putSession[Either[UpstreamErrorResponseWrapper, Seq[AnnualAccount]]](any(), any())(any(), any(), any())
      ...
      "a value is cached" in {
        ...
        when(
          mockSessionCacheRepository.getFromSession[Either[UpstreamErrorResponseWrapper, Seq[AnnualAccount]]](
            any()
          )(any(), any())
        )
