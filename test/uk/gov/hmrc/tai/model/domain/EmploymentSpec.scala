...
class EmploymentSpec extends PlaySpec {
  ...
  // TODO: 9180 Why are below no longer used? Check in main
//  private val singleEmploymentWithMissingPayrollNumber = List(
//    Employment(
//      "XXX PPPP",
//      Live,
//      None,
...
//    )
//  )
//  private val singleEmploymentWithEmptyStringPayrollNumber = List(
//    Employment(
//      "XXX PPPP",
//      Live,
//      Some(""),
...
//    )
//  )
//  private val dualEmployment = List(
//    Employment(
//      "XXX PPPP",
//      Live,
//      Some("64765"),
