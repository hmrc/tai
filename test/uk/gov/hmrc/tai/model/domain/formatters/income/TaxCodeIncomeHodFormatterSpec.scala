  ...
  "taxCodeIncomeSourceReads" must {
    "read taxCodeIncome" when {
      "all income source indicators are false" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(EmploymentIncome, Some(1), BigDecimal(1111),
      ...
      "pension indicator is true" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(PensionIncome, Some(1), BigDecimal(1111),
      ...
      "jobSeekers indicator is true" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(JobSeekerAllowanceIncome, Some(1), BigDecimal(1111),
          "JobSeekerAllowanceIncome", "1150L", "", OtherBasisOperation, Live, BigDecimal(0), BigDecimal(0), BigDecimal(0))
      }
      ...
      "other income source indicator is true" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(OtherIncome, Some(1), BigDecimal(1111),
          "OtherIncome", "1150L", "", OtherBasisOperation, Live, BigDecimal(0), BigDecimal(0), BigDecimal(0))
      }
      ...
      "employment id is not available" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(OtherIncome, None, BigDecimal(0),
          "OtherIncome", "1150L", "", OtherBasisOperation, Live, BigDecimal(0), BigDecimal(0), BigDecimal(0))
      }
      ...
      "taxCode is not available" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(OtherIncome, Some(1), BigDecimal(1111),
          "OtherIncome", "", "", OtherBasisOperation, Live, BigDecimal(0), BigDecimal(0), BigDecimal(0))
      }
    }
    ...
    "utilize totalTaxableIncomeReads to read amount" when {
      ...
      "provided with missing payAndTax element" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(OtherIncome, Some(1), BigDecimal(0),
          "OtherIncome", "1150L", "", OtherBasisOperation, Live, BigDecimal(0), BigDecimal(0), BigDecimal(0))
      }
    }
  }
    ...
    "deserialize the tax account json into the case class with all values" when {
      "all of the fields are provided" in {
        ...
        json.as[Seq[TaxCodeIncome]](taxCodeIncomeSourcesReads) mustBe
          Seq(TaxCodeIncome(EmploymentIncome, Some(1), BigDecimal(0),
            "EmploymentIncome", "1150L", "Employer1", Week1Month1BasisOperation, Live, BigDecimal(0), BigDecimal(0), BigDecimal(0)),
  ...
  "taxCodeIncomeSourceReads using employmentStatus" must {
    ...
    "read status as potentially ceased" when {
      "provided with employmentStatus as 2" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(OtherIncome, Some(1), BigDecimal(0),
          "OtherIncome", "1150L", "", OtherBasisOperation, PotentiallyCeased, BigDecimal(0), BigDecimal(0), BigDecimal(0))
      }
    }
    ...
    "read status as ceased" when {
      "provided with employmentStatus as 3" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(OtherIncome, Some(1), BigDecimal(0),
          "OtherIncome", "1150L", "", OtherBasisOperation, Ceased, BigDecimal(0), BigDecimal(0), BigDecimal(0))
      }
    }
    ...
    "read in year adjustment amounts" when {
      "values are present within tax account JSON" in {
        ...
        json.as[TaxCodeIncome](taxCodeIncomeSourceReads) mustBe TaxCodeIncome(OtherIncome, Some(1), BigDecimal(0),
          "OtherIncome", "1150L", "", OtherBasisOperation, Ceased, BigDecimal(10.20), BigDecimal(30.40), BigDecimal(10.60))
      }
    }
