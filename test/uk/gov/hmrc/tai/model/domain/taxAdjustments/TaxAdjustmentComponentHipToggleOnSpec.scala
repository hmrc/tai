...
class TaxAdjustmentComponentHipToggleOnSpec extends PlaySpec with MockitoSugar {
  "taxAdjustmentComponentReads" must {
      ...
      "relief giving back tax is null" in {
        val json = Json.obj(
          "totalLiabilityDetails" -> Json.obj(
            "reliefsGivingBackTaxDetails" -> JsNull
          )
        )

        json.as[Seq[TaxAdjustmentComponent]](TaxAdjustmentComponentHipToggleOn.taxAdjustmentComponentReads) mustBe Seq
    ...
    "return reliefs giving back tax details" when {
      "relief details are present" in {
        val json = Json.obj(
          "totalLiabilityDetails" -> Json.obj(
            "reliefsGivingBackTaxDetails" -> Json.obj(
  ...
  "TaxAdjustmentComponentHipToggleOn.taxAdjustmentComponentReads" must {
    "return none" when {
      "already taxed details is null" in {
        val json = Json.obj(
          "totalLiabilityDetails" -> Json.obj(
            "alreadyTaxedAtSourceDetails" -> JsNull
          )
        )
    ...
    "return already tax source details" when {
      "already tax details are present" in {
        val json = Json.obj(
          "totalLiabilityDetails" -> Json.obj(
            "alreadyTaxedAtSourceDetails" -> Json.obj(
      ...
      "all the details are present" in {
        val json = Json.obj(
          "totalLiabilityDetails" -> Json.obj(
            ...
            "basicRateExtensionsDetails" -> Json.obj(
  ...
  "taxAdjustmentComponentReads" must {
    "return empty sequence" when {
      "basic rate extension is null" in {
        val json = Json.obj(
          "totalLiabilityDetails" -> Json.obj(
            "basicRateExtensionsDetails" -> JsNull
          )
        )
